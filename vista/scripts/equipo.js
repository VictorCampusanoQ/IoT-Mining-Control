...
{
	$.post("../ajax/equipo.php?op=mostrar",{idequipo : idequipo}, function(data, status)
	{
		...
		$("#imagenmuestra").show();
		$("#imagenmuestra").attr("src","../files/equipos/"+data.imagen);
...
{
	bootbox.confirm("¿Está Seguro de desactivar el Equipo?", function(result){
		if(result)
        {
...
{
	bootbox.confirm("¿Está Seguro de activar el Equipo?", function(result){
		if(result)
        {
